...
class EmailQueueService
{
    ...
    private function handleFailure(EmailQueue $email, string $error): void
    {
        ...
        if ($email->getAttemps() >= $email->getMaxAttemps()) {
            ...
            $retryDelay = 3 ** ($email->getAttemps() - 1) * 5;
    ...
    public function sendEmailConfirmationEmail(
        ...
        $emailQueue->setTemplateId((int) $this->emailConfirmationTemplateId);
    ...
    public function sendPasswordResetEmail(
        ...
        $emailQueue->setTemplateId((int) $this->passwordResetTemplateId);
